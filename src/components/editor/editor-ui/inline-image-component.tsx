   ...
   return (
      <Suspense fallback={null}>
         <>
            ...
            {showCaption && (
               <div className='image-caption-container absolute right-0 bottom-1 left-0 m-0 block min-w-[100px] overflow-hidden border-t bg-white/90 dark:bg-black/90 p-0'>
