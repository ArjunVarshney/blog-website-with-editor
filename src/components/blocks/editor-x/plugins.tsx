...
export function Plugins({}) {
   ...
   return (
      <div className='relative h-full flex flex-col'>
         <ToolbarPlugin>
            {({ blockType }) => (
               <div className='vertical-align-middle sticky top-0 z-10 flex items-center gap-2 border-b p-2 py-3 overflow-x-auto overflow-y-hidden'>
                  ...
                  <div className='h-full'>
                     <div className='h-full' ref={onRef}>
                        <ContentEditable
                           ...
                           className='ContentEditable__root relative block h-full min-h-72 overflow-auto px-8 py-8 focus:outline-none'
                        />
                     </div>
                  </div>
               }
         ...
         <ActionsPlugin>
            <div className='clear-both flex flex-wrap items-center justify-between gap-2 overflow-hidden border-t p-1 px-2 bg-background'>
               <div>
